...
*/
	std::cout << "in espeak main(), option_waveout:" <<  option_waveout << "; quiet:" << quiet << std::endl;
	...
	else
	{
		...
		std::cout << "in espeak main():" << AUDIO_OUTPUT_PLAYBACK << ";" << data_path << std::endl;
	...
	std::cout << "voicename:" << voicename << std::endl;
	...
	std::cout << "speed:" << speed << ";volume:" << volume << ";pitch:" << pitch << ";option_capitals:" << option_capitals 
				<< ";option_punctuation:" << option_punctuation << ";wordgap:" << wordgap << ";option_linelength:" << option_linelength << std::endl;
	if(speed > 0)
